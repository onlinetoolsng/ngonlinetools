...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    featured: true,
    countries: ['nigeria'],
    relatedTools: ['salary-calculator', 'company-income-tax-calculator', 'capital-gains-tax-calculator'],
    relatedArticles: [],
    hasCountryVariants: false,
    requiresApi: false,
  ...
  },
  {
    ...
    featured: true,
    countries: ['nigeria'],
    relatedTools: ['vat-calculator', 'salary-calculator', 'capital-gains-tax-calculator'],
    relatedArticles: [],
    hasCountryVariants: false,
    requiresApi: false,
    launchDate: '2026-07-19',
  ...
  },
  {
    ...
    featured: true,
    countries: ['nigeria'],
    relatedTools: ['vat-calculator', 'company-income-tax-calculator', 'net-worth-calculator', 'capital-gains-tax-calculator'],
    relatedArticles: [],
    hasCountryVariants: false,
    requiresApi: true,
    launchDate: '2026-07-19',
