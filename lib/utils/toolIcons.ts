...
export const TOOL_ICON_MAP: Record<string, string> = {
  ...
  'nigeria-rent-relief-deductions-optimizer': '🏘️',
  'nigeria-budget-creator-tracker': '📒',
  'farm-input-fertilizer-cost-calculator': '🌱',
  'nigeria-freelancer-sme-tax-estimator': '💼',
  'nigeria-invoice-generator': '🧮',
  'cac-business-name-generator': '🏷️',
  'nigeria-crop-yield-estimator': '🌾',
  'land-measurement-converter': '📐',
  'nigeria-agro-land-planner': '🗺️',
  'nigeria-payroll-runner': '🧾',
  'nigeria-rental-yield-roi-calculator': '🏠',
  'mortgage-nhf-affordability-calculator': '🏡',
  'islamic-prayer-times-by-lga': '🕌',
  'nigeria-hajj-umrah-budget-planner': '🕋',
  'nigeria-property-cost-breakdown': '🧱',
  'jamb-aggregate-calculator': '📝',
  'university-cgpa-tracker': '🎓',
  'waec-neco-grade-calculator': '📚',
  'nigeria-school-fees-true-cost-calculator': '🏫',
  'nigeria-student-loan-repayment-estimator': '🎒',
  'bmi-body-fat-calculator': '⚖️',
  'daily-calorie-nigerian-food-calculator': '🍽️',
  'pregnancy-due-date-tracker': '🤰',
  'hospital-bill-cost-estimator': '🏥',
  'zakat-calculator': '☪️',
  'daily-devotional': '📖',
