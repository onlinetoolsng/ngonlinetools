...
async function loadToolComponent(toolSlug: string): Promise<ComponentType<{ locale: string }> | null> {
  try {
    switch (toolSlug) {
      ...
      case 'ghana-susu-savings-calculator': {
        const { default: GhanaSusuCalculator } = await import('@/components/tools/GhanaSusuCalculator')
        return GhanaSusuCalculator
      }
      case 'ghana-bride-price-calculator': {
        const { default: GhanaBridePriceCalculator } = await import('@/components/tools/GhanaBridePriceCalculator')
        return GhanaBridePriceCalculator
      }
      ...
      case 'kenya-rent-deposit-house-hunting-budget-calculator': {
        const { KenyaRentDepositBudgetCalculator } = await import('@/components/tools/KenyaRentDepositBudgetCalculator')
        return KenyaRentDepositBudgetCalculator
      }
      case 'kenya-bride-price-calculator': {
      ...
      case 'south-africa-lobola-budget-planner': {
        const mod = await import('@/components/tools/SouthAfricaLobolaBudgetPlanner')
        return mod.default
      }
      case 'south-africa-matric-aps-calculator': {
        const mod = await import('@/components/tools/SouthAfricaMatricApsCalculator')
        return mod.default
      }
      case 'south-africa-ovulation-calculator': {
        const mod = await import('@/components/tools/SouthAfricaOvulationCalculator')
        return mod.default
      }
      case 'egypt-net-salary-tax-calculator': {
      ...
      case 'south-africa-13th-cheque-bonus-tax-calculator': {
      ...
      case 'ghana-paye-income-tax-calculator': {
      ...
      case 'nigeria-employee-total-cost-calculator': {
  ...
  return ContractorVsEmployeeClassifier
      ...
      case 'nigeria-budget-creator-tracker': {
     const { default: NigeriaBudgetTracker } = await import('@/components/tools/NigeriaBudgetTracker')
     return NigeriaBudgetTracker
      }
      ...
      case 'nigeria-cac-registration-calculator': {
        const { NigeriaCACRegistrationCalculator } = await import('@/components/tools/NigeriaCACRegistrationCalculator')
        return NigeriaCACRegistrationCalculator
      }
      case 'nigeria-crop-yield-estimator': {
      ...
      case 'nigeria-payslip-generator': {
        const { default: NigeriaPayslipGenerator } = await import('@/components/tools/NigeriaPayslipGenerator')
        return NigeriaPayslipGenerator
      }
