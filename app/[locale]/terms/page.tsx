...
export async function generateMetadata({ params }: { params: Promise<Params> }) {
  ...
  return {
    title: locale === 'ar' ? 'شروط الخدمة | ToolBase' : 'Terms of Service | ToolBase',
    description:
      locale === 'ar'
        ? 'شروط وأحكام استخدام موقع ToolBase'
        : 'Terms and conditions for using ToolBase',
          ...
          <div className="prose prose-gray max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600">
            {isAr ? (
              <>
                ...
                <p>باستخدامك لموقع ToolBase، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء منها، يرجى التوقف عن استخدام الموقع.</p>

                <h2>2. وصف الخدمة</h2>
                <p>يوفر ToolBase أدوات وحاسبات مجانية للاستخدام المعلوماتي فقط. تشمل الخدمات حاسبات الرواتب والزكاة وضريبة القيمة المضافة ومكافأة نهاية الخدمة وغيرها.</p>
                ...
                <p>يحق لك استخدام ToolBase للأغراض القانونية المشروعة فقط. يُحظر عليك:</p>
                <ul>
                ...
                <p>لن تكون شبكة JobMeter أو ToolBase مسؤولة عن أي خسائر مباشرة أو غير مباشرة ناتجة عن استخدامك للموقع أو الاعتماد على نتائج الأدوات.</p>
              ...
              <>
                ...
                <p>ToolBase provides free calculators and tools for informational purposes. Services include salary, tax, business, and other calculators.</p>
                ...
                <p>The JobMeter network and ToolBase shall not be liable for any direct or indirect losses resulting from your use of the site or reliance on tool results.</p>
