...
export async function generateMetadata({ params }: { params: Promise<Params> }) {
  ...
  return {
    title: locale === 'ar' ? 'شروط الخدمة | Gulf Tools' : 'Terms of Service | Gulf Tools',
    description:
      locale === 'ar'
        ? 'شروط وأحكام استخدام موقع Gulf Tools'
        : 'Terms and conditions for using Gulf Tools',
          ...
          <div className="prose prose-gray max-w-none prose-headings:font-bold prose-headings:text-gray-900 prose-p:text-gray-600 prose-p:leading-relaxed prose-li:text-gray-600">
            {isAr ? (
              <>
                ...
                <p>باستخدامك لموقع Gulf Tools، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء منها، يرجى التوقف عن استخدام الموقع.</p>

                <h2>2. وصف الخدمة</h2>
                <p>يوفر Gulf Tools أدوات وحاسبات مجانية للاستخدام المعلوماتي فقط. تشمل الخدمات حاسبات الرواتب والزكاة وضريبة القيمة المضافة ومكافأة نهاية الخدمة وغيرها.</p>
                ...
                <p>يحق لك استخدام Gulf Tools للأغراض القانونية المشروعة فقط. يُحظر عليك:</p>
                <ul>
                ...
                <p>لن تكون شبكة JobMeter أو Gulf Tools مسؤولة عن أي خسائر مباشرة أو غير مباشرة ناتجة عن استخدامك للموقع أو الاعتماد على نتائج الأدوات.</p>
              ...
              <>
                ...
                <p>By using Gulf Tools, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, please stop using the site.</p>

                <h2>2. Description of Service</h2>
                <p>Gulf Tools provides free calculators and tools for informational purposes. Services include salary, zakat, VAT, gratuity calculators and more.</p>
                ...
                <p>You may use Gulf Tools for lawful purposes only. You must not:</p>
                <ul>
                ...
                <p>The JobMeter network and Gulf Tools shall not be liable for any direct or indirect losses resulting from your use of the site or reliance on tool results.</p>
